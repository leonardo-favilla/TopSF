...
# Launch with: bash launch_2022EE.sh 2>&1 | tee output_2022EE.log
# Exit on error
set -e

echo "[1/6] Running make_histograms.py..."
python3 make_histograms.py configurations/config_2022EE.yaml

echo "[2/6] Entering directory Trota_TopSF_2022EE/BestTopMixed_mass/"
cd Trota_TopSF_2022EE/BestTopMixed_mass/
...
cd ../../
python3 plot_histograms.py configurations/plot_2022EE.yaml
