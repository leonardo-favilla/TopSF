...
# Launch with: bash launch_2023.sh 2>&1 | tee output_2023.log
# Exit on error
set -e

echo "[1/6] Running make_histograms.py..."
python3 make_histograms.py configurations/config_2023.yaml

echo "[2/6] Entering directory Trota_TopSF_2023/BestTopMixed_mass/"
cd Trota_TopSF_2023/BestTopMixed_mass/
...
cd ../../
python3 plot_histograms.py configurations/plot_2023.yaml
