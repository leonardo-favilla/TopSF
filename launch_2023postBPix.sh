...
# Launch with: bash launch_2023postBPix.sh 2>&1 | tee output_2023postBPix.log
# Exit on error
set -e

echo "[1/6] Running make_histograms.py..."
python3 make_histograms.py configurations/config_2023postBPix.yaml

echo "[2/6] Entering directory Trota_TopSF_2023postBPix/BestTopMixed_mass/"
cd Trota_TopSF_2023postBPix/BestTopMixed_mass/
...
cd ../../
python3 plot_histograms.py configurations/plot_2023postBPix.yaml
